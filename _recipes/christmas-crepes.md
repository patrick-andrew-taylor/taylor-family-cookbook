...
* Nutella — ¼ to ½ cup, as desired
* Whipped Cream — ½ cup, fresh or homemade
* Bananas — 1-2, sliced (optional but recommended)

## Prep Order

For efficiency, prepare components in this order:

1. [Brown Sugar & Mustard Glazed Tofu](brown-sugar-mustard-glazed-tofu.md) — Requires pressing and marinating, which takes ~2 hours total
2. [Berry Compote](berry-compote.md) — Takes ~15 minutes, can cool while tofu bakes
3. [Crepes](crepes.md) — Takes ~20 minutes; stack with parchment between each
4. [Velveeta Sauce](velveeta-sauce.md) — Takes ~10 minutes
